  ...
  return (
    <>
      <Alert
        ...
        description="Chúng tôi sắp ra mắt tính năng Kanban cho phép bạn giúp bạn theo dõi và quản lý các công việc một cách trực quan, đơn giản, và hiệu quả."
        type="info"
        closable
        afterClose={() => {
          console.log('close');
          <Alert message="Thanks" type="success" />;
        }}
      />
      <SimpleBar>
        <div className="flex">
